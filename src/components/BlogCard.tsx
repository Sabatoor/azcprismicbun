    ...
    >
      <article>
        ...
        <div className="p-6">
          ...
          <Link
            href={`${post.url}`}
            className="inline-block rounded bg-color-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-color-base transition duration-150 ease-in hover:bg-color-neutral hover:shadow hover:shadow-color-primary"
          >
            Continue Reading
          </Link>
        </div>
